...
def get_params():
    params = {
        'weight': 'runs\\detect\\终改1P45Depth1SZ224\\weights\\best.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': 'runs\\detect\\YOLOv8n\\weights\\best.pt',
        'device': 'cuda:0',
        'method': 'XGradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM, KPCA_CAM
        'layer': [18, 22],
...
if __name__ == '__main__':
    ...
    model(r'H:\\ultralytics\\save\\NEU_DETTestImg', 'TLFINetXG')
